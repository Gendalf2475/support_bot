...
class Settings(BaseSettings):
    ...
    vk_reconnect_enabled: bool = Field(True, alias="VK_RECONNECT_ENABLED")
    vk_reconnect_delay_seconds: int = Field(10, alias="VK_RECONNECT_DELAY_SECONDS")
    vk_reconnect_max_delay_seconds: int = Field(300, alias="VK_RECONNECT_MAX_DELAY_SECONDS")
    vk_timeout_notify_after_failures: int = Field(5, alias="VK_TIMEOUT_NOTIFY_AFTER_FAILURES")
    ...
    channel_supervisor_enabled: bool = Field(True, alias="CHANNEL_SUPERVISOR_ENABLED")
    channel_restart_enabled: bool = Field(True, alias="CHANNEL_RESTART_ENABLED")
    channel_restart_delay_seconds: int = Field(10, alias="CHANNEL_RESTART_DELAY_SECONDS")
    channel_restart_max_delay_seconds: int = Field(300, alias="CHANNEL_RESTART_MAX_DELAY_SECONDS")
    channel_restart_max_attempts: int = Field(0, alias="CHANNEL_RESTART_MAX_ATTEMPTS")
